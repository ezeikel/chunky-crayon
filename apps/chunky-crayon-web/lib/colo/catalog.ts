...
export const COLO_STAGES: Record<ColoStage, ColoStageInfo> = {
  1: {
    ...
    requiredArtworks: 0,
    imagePath: '/images/colo/stage-1.png',
  },
  2: {
    stage: 2,
    name: 'Little Colo',
    ...
    requiredArtworks: 5,
    imagePath: '/images/colo/stage-2.png',
  },
  3: {
    stage: 3,
    name: 'Growing Colo',
    ...
    requiredArtworks: 15,
    imagePath: '/images/colo/stage-3.png',
  },
  4: {
    stage: 4,
    name: 'Happy Colo',
    ...
    requiredArtworks: 30,
    imagePath: '/images/colo/stage-4.png',
  },
  5: {
    stage: 5,
    name: 'Artist Colo',
    ...
    requiredArtworks: 50,
    imagePath: '/images/colo/stage-5.png',
  },
  6: {
    stage: 6,
    name: 'Master Colo',
    ...
    imagePath: '/images/colo/stage-6.png',
  },
};
...
export const COLO_ACCESSORIES: ColoAccessory[] = [
  {
    ...
    imagePath: '/images/colo/accessories/astronaut-helmet.png',
  },
  {
    id: 'crown',
    name: 'Royal Crown',
    ...
    imagePath: '/images/colo/accessories/crown.png',
  },
  {
    id: 'rainbow-scarf',
    name: 'Rainbow Scarf',
    ...
    imagePath: '/images/colo/accessories/rainbow-scarf.png',
  },
  {
    id: 'party-hat',
    name: 'Party Hat',
    ...
    imagePath: '/images/colo/accessories/party-hat.png',
  },
  {
    id: 'artist-beret',
    name: 'Artist Beret',
    ...
    imagePath: '/images/colo/accessories/artist-beret.png',
  },
  {
    id: 'wizard-hat',
    name: 'Wizard Hat',
    ...
    imagePath: '/images/colo/accessories/wizard-hat.png',
  },
  {
    id: 'dino-spikes',
    name: 'Dino Spikes',
    ...
    imagePath: '/images/colo/accessories/dino-spikes.png',
  },
  {
    id: 'flower-crown',
    name: 'Flower Crown',
    ...
    imagePath: '/images/colo/accessories/flower-crown.png',
  },
  {
    id: 'superhero-cape',
    name: 'Superhero Cape',
    ...
    imagePath: '/images/colo/accessories/superhero-cape.png',
  },
  {
    id: 'sparkle-glasses',
    ...
    imagePath: '/images/colo/accessories/sparkle-glasses.png',
  },
];
