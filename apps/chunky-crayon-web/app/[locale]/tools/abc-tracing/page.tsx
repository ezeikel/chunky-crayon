...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://chunkycrayon.com/en/tools/abc-tracing',
  },
  openGraph: {
  ...
  <div className="max-w-3xl mx-auto py-12 px-4">
    <header className="text-center mb-10">
      ...
      <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
        A full A–Z bundle of printable tracing pages — each letter paired with a
        word, a picture to colour, and a row for handwriting practice. Perfect
        for preschool and early primary.
      </p>
    </header>
