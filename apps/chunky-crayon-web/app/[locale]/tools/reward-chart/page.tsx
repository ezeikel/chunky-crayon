...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://chunkycrayon.com/en/tools/reward-chart',
  },
  openGraph: {
  ...
  <div className="max-w-3xl mx-auto py-12 px-4">
    <header className="text-center mb-10">
      ...
      <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
        Pick a theme, add your child&apos;s name and the behaviors you&apos;re
        tracking, and download a ready-to-print PDF. Works great for potty
        training, bedtime routines, classroom jobs and chores.
      </p>
    </header>
    ...
    <section className="mt-16 space-y-4 text-sm text-muted-foreground max-w-2xl mx-auto">
      ...
      <ol className="list-decimal pl-6 space-y-1">
        ...
        <li>
          Type your child&apos;s name and up to 7 behaviors (bedtime, brushing
          teeth, sharing toys, etc.).
        </li>
