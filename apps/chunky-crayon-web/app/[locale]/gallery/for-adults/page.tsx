        ...
        {validImages.slice(0, 8).map((image) => (
          ...
          >
            <Image
              ...
              alt={image.title || tAlt('adultPage')}
              fill
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
        {adultCategories.map((category) => (
          <Link
            ...
            className="group p-4 rounded-2xl bg-white border-2 border-paper-cream-dark hover:border-crayon-green/50 hover:shadow-md transition-all text-center"
          >
            <div
              className={cn(
      ...
      <section className="bg-paper-cream rounded-3xl p-8 mb-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center">
            <FontAwesomeIcon
              icon={faSpa}
              className="text-4xl mb-3 text-crayon-green"
            />
