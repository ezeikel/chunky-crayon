        ...
        {validImages.slice(0, 8).map((image) => (
          ...
          >
            <Image
              ...
              alt={image.title || tAlt('toddlerPage')}
              fill
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {toddlerCategories.map((category) => (
          <Link
            ...
            className="group p-4 rounded-2xl bg-white border-2 border-paper-cream-dark hover:border-crayon-purple/50 hover:shadow-md transition-all text-center"
          >
            <div
              className={cn(
