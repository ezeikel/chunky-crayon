...
const PrivacyPolicy = () => (
  <PageWrap className="max-w-4xl mx-auto py-12 px-4">
    ...
    <section className="mb-8">
      ...
      <p className="mb-4">
        Welcome to Chunky Crayon, operated by Chewy Bytes Limited
    ...
    <section className="mb-8">
      ...
      <p className="mb-4">
        ...
        Website:{' '}
        <a
          href="https://www.chunkycrayon.com?utm_source=privacy-policy&utm_medium=legal-pages&utm_campaign=legal"
          className="text-blue-600 underline"
        >
