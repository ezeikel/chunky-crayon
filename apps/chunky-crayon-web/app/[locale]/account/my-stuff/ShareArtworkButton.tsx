...
const ShareArtworkButton = ({
  ...
  return (
    <>
      <button
        type="button"
        // Sharing is parent-facing — gate before opening the modal. The
        // gate (rendered globally by ParentalGateProvider) only opens the
        // modal once a grown-up has passed; cancelling just does nothing.
        onClick={() => openGate({ onSuccess: () => setIsModalOpen(true) })}
