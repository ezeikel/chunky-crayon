...
const BirthdayInviteForm = () => {
  ...
  useEffect(() => {
    ...
    trackViewContent({ contentType: 'tool', contentName: 'birthday-invite' });
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Canonical paid-ad lead signal — user kept the output.
      const resourceEventId = `tool_birthday-invite_${Date.now()}`;
      trackResourceSaved({
        method: 'download',
        surface: 'tool',
        contentType: 'pdf',
        contentName: 'birthday-invite',
