...
export default ({ config }: ConfigContext): ExpoConfig => {
  ...
  // Apply the function-form Gradle heap plugin to the assembled config. It's
  // applied here rather than in the `plugins` array because that array's type
  // only accepts string/tuple entries, not a bare ConfigPlugin.
  return withGradleHeap(expoConfig) as ExpoConfig;
};
