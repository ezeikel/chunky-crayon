  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'bg-white rounded-3xl border-4 border-paper-cream-dark shadow-card-lg p-8',
        'duration-200',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          ...
          'text-text-secondary hover:text-crayon-orange hover:bg-paper-cream',
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('font-tondo text-2xl font-bold text-text-primary', className)}
    {...props}
  />
));
