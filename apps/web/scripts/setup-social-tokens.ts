...
const setupMetaTokens = async () => {
  console.log('🚀 Chunky Crayon Social Media API Token Setup Guide\n');
  ...
  console.log(
    '📋 To set up Meta API tokens for coloring page posting, follow these steps:\n',
  );
  ...
  console.log('# Meta API Configuration for Chunky Crayon');
