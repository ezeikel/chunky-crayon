 ...
 *
 * Triggered via curl from the terminal, or from the backfill script —
 * avoids the need for a browser to click anything. Hard-gated to
 * NODE_ENV=development.
 *
 * Usage:
 *   curl -X POST http://localhost:3001/api/dev/regenerate-region-store/<id>
 */
