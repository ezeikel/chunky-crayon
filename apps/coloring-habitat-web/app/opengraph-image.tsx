...
const TAGLINE = "Adult coloring pages, made on demand.";
...
export default async function Image() {
  ...
  if (featured.length === 0) {
    return new ImageResponse(renderTextFallback(), {
      ...size,
      fonts: fontExports,
    });
  }

  return new ImageResponse(renderCollage(featured), {
    ...size,
    fonts: fontExports,
  });
}

const renderCollage = (images: FeaturedOGImage[]) => (
  <div
    style={{
      width: "100%",
      height: "100%",
