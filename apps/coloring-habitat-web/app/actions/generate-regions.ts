...
/**
 * Region store config for Coloring Habitat. Uses the existing CH region fill
 * points prompt as the base and the shared default palette variant modifiers
 * (CH can tune the modifiers here if the wellness tone needs a different
 * take on "cute" or "surprise").
 */
