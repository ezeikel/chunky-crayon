...
export const COLORING_PALETTE = {
  ...
  extended: [
    ...
    // Natural mid-tones — AI auto-color / Magic Brush ONLY (not kid crayon
    // buttons). Closes measured snap-ΔE gaps in warm-neutral / sage-green /
    // soft-blue / neutral-grey. Keep in sync with chunky-crayon-web
    // constants.ts + chunky-crayon-worker _prompts.ts.
