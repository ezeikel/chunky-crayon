...
const PaymentFailedEmail = ({
  ...
  <Html>
    <Head />
    <Preview>
      Action needed: Your Coloring Habitat payment could not be processed
    </Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={infoSection}>
          ...
          <Text style={infoItem}>
            <span style={bullet}>&bull;</span> We&apos;ll retry your payment in
            a few days
          </Text>
          <Text style={infoItem}>
            <span style={bullet}>&bull;</span> Your credits will continue to
            work for now
          </Text>
          <Text style={infoItem}>
            <span style={bullet}>&bull;</span> Update your payment method to
            avoid interruption
          </Text>
        </Section>
...
// Styles - earthy/nature palette for Habitat branding
const main = {
