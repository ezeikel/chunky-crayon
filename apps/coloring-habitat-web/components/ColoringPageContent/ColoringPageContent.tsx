  ...
  return (
    ...
    <div className="flex flex-col gap-y-4 @container">
      ...
      <div className="flex flex-col items-center gap-2 max-w-3xl xl:max-w-none w-full mx-auto xl:px-4">
        ...
        <h1 className="hidden md:block font-coloring-heading font-bold text-2xl md:text-3xl text-coloring-text-primary text-center">
          {title}
        </h1>
      ...
      <div className="flex justify-center xl:justify-between items-start gap-4 xl:gap-6 @[1400px]:gap-8">
        ...
        <div className="max-w-3xl w-full flex-1 xl:max-w-none xl:min-w-[600px]">
          ...
          <div className="bg-white rounded-2xl border-2 border-coloring-surface-dark p-4 md:p-6 @[1600px]:p-8 shadow-sm">
            <ColoringArea
              ref={coloringAreaRef}
            ...
            actions={
              <>
                ...
                <ShareButton
                  ...
                  description={`Color this ${coloringImage?.title || "coloring page"} on Coloring Habitat.`}
