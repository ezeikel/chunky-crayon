...
export const ColoringContextProvider = ({
  ...
  useEffect(() => {
    setIsMuted(localStorage.getItem("coloring-habitat-muted") === "true");
    setIsSfxMuted(
      localStorage.getItem("coloring-habitat-sfx-muted") === "true",
    );
    setIsAmbientMuted(
      localStorage.getItem("coloring-habitat-ambient-muted") === "true",
    );
    setIsHydrated(true);
  }, []);
  ...
  useEffect(() => {
    if (isHydrated) {
      localStorage.setItem("coloring-habitat-muted", String(isMuted));
    }
  }, [isMuted, isHydrated]);

  useEffect(() => {
    if (isHydrated) {
      localStorage.setItem("coloring-habitat-sfx-muted", String(isSfxMuted));
    }
  ...
  useEffect(() => {
    if (isHydrated) {
      localStorage.setItem(
        "coloring-habitat-ambient-muted",
