...
export const DINO_DANCE_PARTY: HeroBundle = {
  ...
  pagePrompts: [
    ...
    // page 7
    "Two friendly cartoon dinosaurs performing a duet on a small rock stage. On the LEFT: a T-rex facing the viewer wearing oversized round headphones, both stubby T-rex arms raised holding two drumsticks, in front of a small bone-drum kit. On the RIGHT: a velociraptor facing the viewer with a small punk-feather tuft on its head, both arms extended to play a guitar made from a giant rib bone, with both wrist bands clearly visible on each arm. Simple jungle backdrop, music notes floating around. Both characters fully visible, no overlap.",
    "A friendly cartoon stegosaurus standing in a 3/4 angle view (body turned to show the back), all six heart-shaped back plates clearly visible across the spine in heart-shape silhouette, leading a small conga line of three tiny silhouetted baby dinosaurs trailing behind, in front of a friendly volcano that's gently erupting heart-shaped confetti into the sky. Stegosaurus is the foreground hero — fully visible and detailed; the baby dinosaurs behind are smaller and simpler.",
    ...
    "Two friendly cartoon dinosaurs on top of a tall flat jungle rock under a starry night sky. On the LEFT: a T-rex facing the viewer wearing oversized round headphones, both stubby T-rex arms raised up showing rounded fingers, in a triumphant DJ pose behind a small stacked-rock turntable. On the RIGHT: a velociraptor facing the viewer with a small punk-feather tuft on its head, both arms extended in a dance pose with both wrist bands clearly visible on each arm. Music note fireworks scattered in the starry sky behind them. Both characters fully visible at full body, no overlap.",
  ],
};
