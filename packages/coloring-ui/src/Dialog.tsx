...
/**
 * Shared Dialog primitive — Radix-based, token-styled.
 *
 * Both apps get the same overlay/content/animation behaviour; each brand
 * automatically gets its own look via `coloring-*` tokens:
 * - surface: `bg-white border border-coloring-surface-dark`
 * - radius: `rounded-coloring-card`
 * - close-button colour: `text-coloring-text-secondary`, hover accent
 * - header typography: `font-coloring-heading` + token colours
 */
